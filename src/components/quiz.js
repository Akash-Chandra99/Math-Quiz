...
function Quiz({  question,setGameState,setQuestion,operandRange, setScore,score,noOfQuestion }) {
    ...
    useEffect(() => {
        ...
        let result = parseFloat(Math.trunc(res*100)/100).toString();
    ...
    const nextClickHandler = (e) => {
        ...
        data.push(data[1] === data[2].toLowerCase())
        if(data[3]){
    ...
    return (
        <div className="quiz-screen">
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control" id="user-answer" type="string" name="currentAnswer" value={currentAns} onChange={changeHandler} />
                    </div>
